...
import (
	...
	"github.com/LynnColeArt/guda/compute/asm/f64"
)
...
func (Implementation) Dgemm(tA, tB blas.Transpose, m, n, k int, alpha float64, a []float64, lda int, b []float64, ldb int, beta float64, c []float64, ldc int) {
	...
	// Use fixed version to avoid the 20-column shift bug
	dgemmParallelFixed(aTrans, bTrans, m, n, k, a, lda, b, ldb, c, ldc, alpha)
}

func dgemmParallel(aTrans, bTrans bool, m, n, k int, a []float64, lda int, b []float64, ldb int, c []float64, ldc int, alpha float64) {
	// BUG: This function has issues with matrix indexing. Disabled for now.
...
func dgemmSerialNotNot(m, n, k int, a []float64, lda int, b []float64, ldb int, c []float64, ldc int, alpha float64) {
	...
	if alpha == 1.0 && f64.HasGemmKernel {
		// Use fixed version to handle edge cases properly
		dgemmSerialNotNotKernelFixed(m, n, k, a, lda, b, ldb, c, ldc)
		return
	}
